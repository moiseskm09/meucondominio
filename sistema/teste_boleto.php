...
#Dados do boleto
while ($resultadoSacado = mysqli_fetch_assoc($buscaSacado)) {
...
$teste = mysqli_query($conexao, "SELECT bol_numero FROM boletos ORDER BY bol_numero DESC LIMIT 1");
$result = mysqli_fetch_assoc($teste);
$numero = $result['bol_numero'] + 1;
$dataemissao = date("Y-m-d");
$datavencimento = '2021-05-20';
$bol_valor = $resultadoSacado['m_valoraluguel'];

$fields = array(
'boleto.conta.token'=> "api-key_rq0o3u6atdJViXoGKJTQoBz0QhjhEfgwqfMnyajQEaE=" ,
'boleto.emissao'=> $dataemissao,
'boleto.vencimento'=> $datavencimento,
'boleto.documento'=> 'EX1',
'boleto.numero'=> $numero.'-1',
'boleto.titulo'=> 'FAT',
'boleto.valor'=> $bol_valor,
'boleto.pagador.nome'=> $resultadoSacado['m_nome'].$resultadoSacado['m_sobrenome'],
'boleto.pagador.cprf'=> $resultadoSacado['m_cpf'],
'boleto.pagador.endereco.cep'=> $resultadoSacado['m_cep'],
'boleto.pagador.endereco.uf'=> $resultadoSacado['m_estado'],
'boleto.pagador.endereco.localidade'=> $resultadoSacado['m_cidade'],
'boleto.pagador.endereco.bairro'=> $resultadoSacado['m_bairro'],
'boleto.pagador.endereco.logradouro'=> $resultadoSacado['m_endereco'],
'boleto.pagador.endereco.numero'=> $resultadoSacado['m_numerocasa'],
//'boleto.pagador.endereco.complemento'=> 'não possui',
...
$cod_cliente = $resultadoSacado['m_cod'];
$bol_empresa = $resultadoCedente['emp_id'];
$bol_conta = $resultadoCedente['conta_id'];

    mysqli_query($conexao, "INSERT INTO boletos (bol_numero, bol_codcliente, bol_empresa, bol_conta, bol_emissao, bol_vencimento, bol_valor) VALUES ('$numero', '$cod_cliente', '$bol_empresa', '$bol_conta', '$dataemissao', '$datavencimento', '$bol_valor')");
...
curl_setopt($ch, CURLOPT_USERPWD, "api-key_chLU72Ynztvfj3ysn2n-JNaZE0gMClQnbz48Ms4EH7M=:token"); #API TOKEN
