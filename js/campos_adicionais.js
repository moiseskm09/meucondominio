var cont = 1;
        $('#btnmorador').click(function () {
             var codigo = document.getElementById("vai").value;
cont++;
...
var button_id = $(this).attr("id");
        ...
        var cont = 1;
        var codigomempregado = document.getElementById("codmempregado").value;
...
var button_id = $(this).attr("id");
        ...
        var cont = 1;
        var codigomveiculo = document.getElementById("codmveiculo").value;
...
var button_id = $(this).attr("id");
        $('#campoveiculo' + button_id + '').remove();
            ...
            var cont = 1;
            var codmanimais = document.getElementById("codmanimais").value;
